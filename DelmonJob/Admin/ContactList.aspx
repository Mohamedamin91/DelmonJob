<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster2.Master" AutoEventWireup="true" CodeBehind="ContactList.aspx.cs" Inherits="DelmonJob.Admin.ContactList" %>
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" 
                    ...
                    <Columns>
                        ...
                        <ItemStyle HorizontalAlign="Center" />
                          ...
                          <asp:BoundField HeaderStyle-Font-Bold="false" DataField="Subject" HeaderText="Subject">
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>

                          <asp:BoundField HeaderStyle-Font-Bold="false" DataField="Message" HeaderText="Message">
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
